...
public class serverForMulitplayerTest {
    private int port=8888;
    private ServerSocket serverSocket;
    private ExecutorService executorService;//thread pool
    private final int POOL_SIZE=10;//thread pool size

    public serverForMulitplayerTest() throws IOException{
    ...
    public static void main(String[] args) throws IOException {
        new serverForMulitplayerTest().service();
...
class pickPlayer1 implements Runnable{
    private Socket socket;
	private int[] countArray;
	public pickPlayer1(Socket socket, int[] countArray){
        this.socket=socket;
...
class game1 implements Runnable{
	...
	private int[] countArray;
	private int player;
    public game1(Socket socket, int[] countArray,int player){
        this.socket=socket;
        this.countArray = countArray;
        this.player = player;
